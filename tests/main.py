...
class MainTests(unittest.TestCase):
    ...
    def test_photo_mode(self):
        ...
        self.assertEqual(
            self.gopro.mode(
                constants.Mode.PhotoMode, constants.Mode.SubMode.Photo.Single_H5
            ),
            RESP_OK,
        )
    ...
    def test_take_photo(self):
        ...
        time.sleep(SLEEP_SEC)
        self.gopro = GoProCamera.GoPro()
        self.assertIn(VALID_HERO5_MEDIA_PATH, self.gopro.take_photo())

    def test_shoot_video(self):
        print("shoot_video(5)")
        time.sleep(SLEEP_SEC)
        self.gopro = GoProCamera.GoPro()
        self.assertIn(VALID_HERO5_MEDIA_PATH, self.gopro.shoot_video(5))
    ...
    def test_recording_status(self):
        ...
        time.sleep(SLEEP_SEC)
        self.gopro = GoProCamera.GoPro()
        self.assertEqual(self.gopro.IsRecording(), 0)

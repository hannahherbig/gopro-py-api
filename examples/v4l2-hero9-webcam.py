...
print(
    'Run modprobe v4l2loopback device=1 video_nr=44 card_label="GoPro" exclusive_caps=1'
)
input("Hit enter when done!")
gopro = GoProCamera.GoPro(
    ip_address=GoProCamera.GoPro.getWebcamIP(sys.argv[1]),
    camera=constants.gpcontrol,
    webcam_device=sys.argv[1],
)
